  ...
  <div class="container">
    ...
    <main class="main-container">
      <div class="card-container">
        <div v-for="(book, index) in filteredBooks" :key="index" class="book-card" @click="NameTo(book)" @mouseover="showHoverTrue(index)" @mouseout="showHoverFalse(index)">
          <img :src="require('@/assets/BooksImg/' + book.books.Image)" class="book-image">
          <div class="book-name">{{ book.books.name }}</div>
          <div class="hover-container">
            <div class="hover-window" :class="{ 'show-hover': showHover[index] }">
